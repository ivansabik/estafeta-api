...
class RastreoTest extends \PHPUnit_Framework_TestCase {
    ...
    # TODO: Agregar comentarios cuando se fixee scheiss bug buggiento
    # TODO: Agregar movimientos
        ...
        return array(
            array(
                array(
                    ...
                    'peso_vol' => '0.0',
                    'movimientos' => array(
                        array('fecha' => '28/11/2013 02:30 PM', 'lugar_movimiento' => 'Recolección en oficina por ruta local'),
                        array('fecha' => '28/11/2013 12:19 PM', 'lugar_movimiento' => 'Envío recibido en oficina'),
                        array('fecha' => '27/11/2013 07:18 PM', 'lugar_movimiento' => 'Carga Aerea AER Aclaración en proceso'),
                        array('fecha' => '27/11/2013 04:18 PM', 'lugar_movimiento' => 'Envío recibido en oficina'),
                        array('fecha' => '27/11/2013 09:19 AM', 'lugar_movimiento' => 'Estación Aérea MEX En proceso de entrega Av Central 161 Impulsora Popular Avicola Nezahualcoyotl'),
                        array('fecha' => '27/11/2013 07:24 AM', 'lugar_movimiento' => 'Estación Aérea MEX Llegada a centro de distribución AMX Estación Aérea MEX'),
                        array('fecha' => '26/11/2013 07:05 PM', 'lugar_movimiento' => 'MEXICO D.F. En ruta foránea hacia MX2-México (zona 2)'),
                        array('fecha' => '26/11/2013 07:03 PM', 'lugar_movimiento' => 'MEXICO D.F. Llegada a centro de distribución MEX MEXICO D.F.'),
                        array('fecha' => '26/11/2013 06:55 PM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento en centro de distribución'),
                        array('fecha' => '26/11/2013 06:55 PM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento en centro de distribución'),
                        array('fecha' => '26/11/2013 03:17 PM', 'lugar_movimiento' => 'MEXICO D.F. Aclaración en proceso'),
                        array('fecha' => '23/11/2013 10:42 AM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento Local'),
                        array('fecha' => '22/11/2013 12:00 PM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento en centro de distribución'),
                        array('fecha' => '22/11/2013 11:33 AM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento Local'),
                        array('fecha' => '22/11/2013 11:05 AM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento en centro de distribución'),
                        array('fecha' => '22/11/2013 10:58 AM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento Local'),
                        array('fecha' => '21/11/2013 07:00 PM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento en centro de distribución'),
                        array('fecha' => '21/11/2013 06:56 PM', 'lugar_movimiento' => 'MEXICO D.F. Llegada a centro de distribución MEX MEXICO D.F.'),
                    )
                )
            ),
            array(
                array(
                    ...
                    'peso_vol' => '1.9',
                    'movimientos' => array(
                        array('fecha' => '26/11/2013 02:31 PM', 'lugar_movimiento' => 'MEXICO D.F. Aclaración en proceso'),
                        array('fecha' => '26/11/2013 10:49 AM', 'lugar_movimiento' => 'MEXICO D.F. Aclaración en proceso'),
                        array('fecha' => '31/10/2013 10:04 AM', 'lugar_movimiento' => 'Recolección en oficina por ruta local'),
                        array('fecha' => '31/10/2013 09:12 AM', 'lugar_movimiento' => 'MEXICO D.F. En proceso de entrega MEX MEXICO D.F.'),
                        array('fecha' => '30/10/2013 08:39 PM', 'lugar_movimiento' => 'MEXICO D.F. Movimiento en centro de distribución'),
                        array('fecha' => '30/10/2013 07:52 PM', 'lugar_movimiento' => 'MEXICO D.F. Llegada a centro de distribución MEX MEXICO D.F.'),
                        array('fecha' => '30/10/2013 06:06 PM', 'lugar_movimiento' => 'Recolección en oficina por ruta local'),
                        array('fecha' => '30/10/2013 06:02 PM', 'lugar_movimiento' => 'Envío recibido en oficina'),
                        array('fecha' => '30/10/2013 02:00 PM', 'lugar_movimiento' => 'Envio recibido en oficina Av Adolfo Lopez Mateos 22 Local 4 Puente de Vigas Tlalnepantla'),
                    ),
                )
            ),
            array(
                array(
                    ...
                    'peso_vol' => '4.7',
                    'movimientos' => array(
                        array('fecha' => '12/02/2014 09:14 AM', 'lugar_movimiento' => 'MEXICO D.F. En proceso de entrega MEX MEXICO D.F.'),
                        array('fecha' => '12/02/2014 08:27 AM', 'lugar_movimiento' => 'MEXICO D.F. Llegada a centro de distribución'),
                        array('fecha' => '11/02/2014 11:43 PM', 'lugar_movimiento' => 'Centro de Int. SLP En ruta foránea hacia MEX-MEXICO D.F.'),
                        array('fecha' => '08/02/2014 12:49 PM', 'lugar_movimiento' => 'Recolección en oficina por ruta local'),
                        array('fecha' => '07/02/2014 06:26 PM', 'lugar_movimiento' => 'Tijuana En ruta foránea hacia MEX-MEXICO D.F.'),
                        array('fecha' => '07/02/2014 05:04 PM', 'lugar_movimiento' => 'Envío recibido en oficina'),
                        array('fecha' => '07/02/2014 04:58 PM', 'lugar_movimiento' => 'Recolección en oficina por ruta local'),
                        array('fecha' => '07/02/2014 04:43 PM', 'lugar_movimiento' => 'Envio recibido en oficina CARRETERA AL AEROPUERTO AEROPUERTO TIJUANA BC')
                    ),
                )
            )
        );
    ...
    public function testNumeroGuia($arrDatos) {
        $this->markTestIncomplete('testNumeroGuia() no esta definido');
    }
    ...
    public function testCodigoRastreo($arrDatos) {
        $this->markTestIncomplete('testCodigoRastreo() no esta definido');
    }
    ...
    public function testOrigen($arrDatos) {
        $this->markTestIncomplete('testOrigen() no esta definido');
    }
    ...
    public function testDestino($arrDatos) {
        $this->markTestIncomplete('testDestino() no esta definido');
    }
    ...
    public function testServicio($arrDatos) {
        $this->markTestIncomplete('testServicio() no esta definido');
    }
    ...
    public function testFechaProgramada($arrDatos) {
        $this->markTestIncomplete('testFechaProgramada() no esta definido');
    }
    ...
    public function testCodigoPostalDestino($arrDatos) {
        $this->markTestIncomplete('testCodigoPostalDestino() no esta definido');
    }
    ...
    public function testFechaRecoleccion($arrDatos) {
        $this->markTestIncomplete('testFechaRecoleccion() no esta definido');
    }
    ...
    public function testEstatusEnvio($arrDatos) {
        $this->markTestIncomplete('testEstatusEnvio() no esta definido');
    }
    ...
    public function testFechaEntrega($arrDatos) {
        $this->markTestIncomplete('testFechaEntrega() no esta definido');
    }
    ...
    public function testTipoEnvio($arrDatos) {
        $this->markTestIncomplete('testTipoEnvio() no esta definido');
    }
    ...
    public function testRecibio($arrDatos) {
        $this->markTestIncomplete('testRecibio() no esta definido');
    }
    ...
    public function testFirmaRecibido($arrDatos) {
        $this->markTestIncomplete('testFirmaRecibido() no esta definido');
    }
    ...
    public function testPeso($arrDatos) {
        $this->markTestIncomplete('testPeso() no esta definido');
    }
    ...
    public function testPesoVolumetrico($arrDatos) {
        $this->markTestIncomplete('testPesoVolumetrico() no esta definido');
    }
    ...
    public function testHistorial($arrDatos) {
        $this->markTestIncomplete('testHistorial() no esta definido');
    }
